...
module.exports = {
    async index(req, res) {
        const contact = await Contact.find().populate('group');
        res.json(contact);
    },
    async create(req, res) {

        try {
            const { nome_contato, email_contato, telefone_contato, grupo } = req.body;
            ...
            if (!contact) {
                ...
                /*contact = await Contact.create({...data, group: grupo});*/
